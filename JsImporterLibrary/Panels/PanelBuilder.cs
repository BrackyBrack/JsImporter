    ...
    public static class PanelBuilder
    {
        public static List<Panel> GetPanels()
        {
            List<Panel> panels = new List<Panel>
            {
                ...
                , new Panel{Name = "50E", SeedDate = new DateTime(2020, 12, 16), NumberOfDaysInPanel = 27, NumberOfDaysBetweenPanels = 29, PanelType = PanelType.MOMO }
                , new Panel{Name = "50F", SeedDate = new DateTime(2021, 1, 13), NumberOfDaysInPanel = 27, NumberOfDaysBetweenPanels = 29, PanelType = PanelType.MOMO }
                , new Panel{Name = "50G", SeedDate = new DateTime(2020, 12, 23), NumberOfDaysInPanel = 27, NumberOfDaysBetweenPanels = 29, PanelType = PanelType.MOMO }
                , new Panel{Name = "50H", SeedDate = new DateTime(2021, 1, 20), NumberOfDaysInPanel = 27, NumberOfDaysBetweenPanels = 29, PanelType = PanelType.MOMO }
                ...
                , new Panel{Name = "502", SeedDate = new DateTime(2021, 3, 24), NumberOfDaysInPanel = 13, NumberOfDaysBetweenPanels = 15, PanelType = PanelType.TOTO }
                , new Panel{Name = "503", SeedDate = new DateTime(2021, 3, 17), NumberOfDaysInPanel = 13, NumberOfDaysBetweenPanels = 15, PanelType = PanelType.TOTO }
